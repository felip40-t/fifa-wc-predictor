...
def main() -> None:
    """Pretty-print a competition's simulated outcomes.
    ...
    overridden with the first CLI argument (defaults to world_cup_2026).
    """
    competition = sys.argv[1] if len(sys.argv) > 1 else "world_cup_2026"
    display_simulated_outcomes(f"data/processed/simulated_outcomes_{competition}.csv")
